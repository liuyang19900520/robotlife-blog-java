...
import com.liuyang19900520.robotlife.blog.shiro.filter.JwtAuthFilter;
import com.liuyang19900520.robotlife.blog.shiro.filter.JwtPermAuthFilter;
import com.liuyang19900520.robotlife.blog.shiro.filter.JwtRoleAuthFilter;
import com.liuyang19900520.robotlife.blog.shiro.realm.HmacRealm;
import com.liuyang19900520.robotlife.blog.shiro.realm.JwtRealm;
import com.liuyang19900520.robotlife.blog.web.interceptor.HttpServletRequestReplacedFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultSecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/admin/**", "json,jwt");
